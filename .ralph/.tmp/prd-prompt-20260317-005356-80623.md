...
Save the PRD as JSON in directory: /Users/dartsiukhou/dev/personal/opencode-openai-api-converter/.agents/tasks
...
User request:
prd is located in  ~/dev/personal/opencode-openai-api-converter/PRD.md.
